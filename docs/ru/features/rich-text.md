...
<Screenshot src="/lingua-docs/screenshots/editor-toolbar.png" alt="Панель инструментов редактора" caption="Панель инструментов HTML-редактора с активными параметрами по умолчанию." />
