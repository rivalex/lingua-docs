...
<Screenshot src="/screenshots/language-add-modal.png" alt="Modale per aggiungere una lingua" caption="La modale di aggiunta lingua con selettore di locale ricercabile." width="640px" :center="true"/>
